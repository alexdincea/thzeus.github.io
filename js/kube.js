  ...
  Accordion.fn = $.Accordion.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          ...
          if (
            namespace == "tools." + $.Accordion.NAME ||
            namespace == $.Accordion.NAME + ".tools"
          ) {
    ...
    setStatus: function(command) {
      ...
      $.each(items, function(i, s) {
        if (command == "close") {
          s.removeClass("accordion-" + i + "-opened").addClass(
            "accordion-" + i + "-closed"
          );
        } else {
          s.removeClass("accordion-" + i + "-closed").addClass(
            "accordion-" + i + "-opened"
          );
        }
      });
...
(function($) {
  ...
  Autocomplete.fn = $.Autocomplete.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Autocomplete.NAME ||
            namespace == $.Autocomplete.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    build: function() {
      ...
      this.placement =
        $(document).height() - (this.pos.top + this.elementHeight) <
        this.result.height()
          ? "top"
          : "bottom";
      ...
      $.ajax({
        ...
        success: $.proxy(function(json) {
          ...
          $.each(
            ...
            $.proxy(function(i, s) {
              var li = $("<li>");
              var a = $('<a href="#" rel="' + s.id + '">')
                .html(s.value)
                .on("click", $.proxy(this.set, this));
          ...
          var top =
            this.placement === "top"
              ? this.pos.top - this.result.height() - this.elementHeight
              : this.pos.top + this.elementHeight;
    ...
    hide: function(e) {
      if (
        e &&
        ($(e.target).hasClass("autocomplete-in") ||
          $(e.target).hasClass("autocomplete-open") ||
          $(e.target)
            .parents()
            .hasClass("autocomplete-open"))
      ) {
        return;
      }
...
(function($) {
  ...
  Buttons.fn = $.Buttons.prototype = {
    ...
    getButtons: function() {
      return this.opts.type === "toggle"
        ? this.$element
        : this.$element.find("." + this.opts.className);
    },
    getValue: function() {
      return this.opts.type === "segmented"
        ? $(this.opts.target)
            .val()
            .split(",")
        : $(this.opts.target).val();
    },
    setDefault: function($el) {
      if (
        this.opts.type === "segmented" &&
        $.inArray($el.val(), this.value) !== -1
      ) {
        this.setActive($el);
      } else if (
        (this.opts.type === "toggle" && this.value === 1) ||
        this.value === $el.val()
      ) {
        this.setActive($el);
      }
  ...
  CheckAll.fn = $.CheckAll.prototype = {
    ...
    load: function() {
      if (this.$element.prop("checked")) {
        ...
        if (this.opts.parent)
          this.$elements.each($.proxy(this.removeHighlight, this));
    ...
    setOnStart: function(i, el) {
      ...
      if (
        ...
        (this.setter && $.inArray($el.val(), this.setter) !== -1)
      ) {
    ...
    removeHighlight: function(i, $el) {
      ...
      $($el)
        .closest(this.opts.parent)
        .removeClass(this.opts.highlight);
    },
...
(function($) {
  ...
  Dropdown.fn = $.Dropdown.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Dropdown.NAME ||
            namespace == $.Dropdown.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    getPosition: function() {
      return this.$element.closest(".navigation-fixed").size() !== 0
        ? "fixed"
        : "absolute";
    },
    ...
    show: function() {
      ...
      $(document).on(
        "click.tools.dropdown touchstart.tools.dropdown",
        $.proxy(this.hide, this)
      );

      if (this.opts.targetClose) {
        $(this.opts.targetClose).on(
    ...
    hide: function(e) {
      if (e) {
        ...
        if (
          ...
          $target.hasClass("dropdown-in") ||
          $target.closest(".dropdown-open").size() !== 0
        ) {
          return;
        }
      }
...
(function($) {
  ...
  InfinityScroll.fn = $.InfinityScroll.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.InfinityScroll.NAME ||
            namespace == $.InfinityScroll.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    build: function() {
      $(window).on(
        "DOMContentLoaded.tools.infinite-scroll load.tools.infinite-scroll resize.tools.infinite-scroll scroll.tools.infinite-scroll",
        $.proxy(function() {
  ...
  Message.fn = $.Message.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Message.NAME ||
            namespace == $.Message.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    show: function() {
      ...
      this.$message
        .addClass("open")
        .fadeIn("fast")
        .on("click.tools.message", $.proxy(this.hide, this));
...
(function($) {
  ...
  Modal.fn = $.Modal.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Modal.NAME ||
            namespace == $.Modal.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    buildOverlay: function() {
      ...
      if (this.opts.blur) {
        this.blurredElements = $("body")
          .children("div, section, header, article, pre, aside, table")
          .not(".modal, .modal-box, #modal-overlay");
    ...
    setContent: function() {
      if (
        typeof this.opts.content == "object" ||
        this.opts.content.search("#") === 0
      ) {
        this.type = "html";
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.NavigationFixed.NAME ||
            namespace == $.NavigationFixed.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.NavigationToggle.NAME ||
            namespace == $.NavigationToggle.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Tabs.NAME ||
            namespace == $.Tabs.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
  ...
  Textfit.fn = $.Textfit.prototype = {
    ...
    init: function(el, options) {
      ...
      this.$element.css(
        ...
        Math.max(
          Math.min(
            this.$element.width() / (this.opts.compressor * 10),
            parseFloat(this.opts.max)
          ),
          parseFloat(this.opts.min)
        )
      );
    },
    loadOptions: function(options) {
...
(function($) {
  ...
  Upload.fn = $.Upload.prototype = {
    ...
    setCallback: function(type, e, data) {
      ...
      if (events && typeof events[type] != "undefined") {
        ...
        for (var i = 0; i < len; i++) {
          var namespace = events[type][i].namespace;
          if (
            namespace == "tools." + $.Upload.NAME ||
            namespace == $.Upload.NAME + ".tools"
          ) {
            var callback = events[type][i].handler;
            value.push(
              typeof data == "undefined"
    ...
    load: function() {
      ...
      this.$placeholdler = $('<div class="tools-droparea-placeholder" />').text(
      ...
      this.$droparea.on(
        "dragleave.tools.upload",
        $.proxy(this.onDragLeave, this)
      );
